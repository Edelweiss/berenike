...
--
-- Tabellenstruktur für Tabelle `locus_t`
--

CREATE TABLE `locus_t` (
  `Locus_number` int(11) NOT NULL,
  `trench_id` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;

--
-- Daten für Tabelle `locus_t`
--

INSERT INTO `locus_t` (`Locus_number`, `trench_id`) VALUES
(1, NULL),
(2, NULL),
(3, NULL),
(4, NULL),
...
--
-- Tabellenstruktur für Tabelle `pottery_bucket`
--

CREATE TABLE `pottery_bucket` (
  `id` int(11) DEFAULT NULL,
  `Pottery_bucket_number` int(11) NOT NULL,
  `locus_id` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;

--
-- Daten für Tabelle `pottery_bucket`
--

INSERT INTO `pottery_bucket` (`id`, `Pottery_bucket_number`, `locus_id`) VALUES
(1, 1, 1),
(NULL, 2, NULL),
(NULL, 3, NULL),
(NULL, 4, NULL),
...
--
-- Tabellenstruktur für Tabelle `textile_locus`
--

CREATE TABLE `textile_locus` (
  `Locus_number1` int(11) NOT NULL,
  `Textile_ID12` bigint(20) NOT NULL,
  `Locus_addition` varchar(1000) DEFAULT NULL,
  `id` int(11) DEFAULT NULL,
  `tmp_id` varchar(512) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;

--
-- Daten für Tabelle `textile_locus`
--

INSERT INTO `textile_locus` (`Locus_number1`, `Textile_ID12`, `Locus_addition`, `id`, `tmp_id`) VALUES
(1, 371059, NULL, NULL, NULL),
(1, 381059, NULL, NULL, NULL),
(1, 391059, NULL, NULL, NULL),
(1, 401059, NULL, NULL, NULL),
(1, 411059, NULL, NULL, NULL),
(1, 421059, NULL, NULL, NULL),
(1, 431059, NULL, NULL, NULL),
(1, 441059, NULL, NULL, NULL),
(1, 451059, NULL, NULL, NULL),
(1, 461059, 'C; West Baulk Trim', NULL, NULL),
(1, 471059, NULL, NULL, NULL),
(1, 481059, NULL, NULL, NULL),
(1, 491059, NULL, NULL, NULL),
(1, 551059, NULL, NULL, NULL),
(1, 561059, NULL, NULL, NULL),
(1, 571059, NULL, NULL, NULL),
(1, 581059, NULL, NULL, NULL),
(1, 591059, 'the piece from PB001', NULL, NULL),
(1, 711059, NULL, NULL, NULL),
(1, 721059, NULL, NULL, NULL),
(1, 731059, NULL, NULL, NULL),
(1, 741059, NULL, NULL, NULL),
(1, 751059, NULL, NULL, NULL),
(1, 761059, NULL, NULL, NULL),
(1, 771059, 'A; East Baulk Trim', NULL, NULL),
(1, 781059, 'A; East Baulk Trim', NULL, NULL),
(1, 801059, 'A; East Baulk Trim', NULL, NULL),
(1, 811059, 'A; East Baulk Trim', NULL, NULL),
(1, 821059, 'A; East Baulk Trim', NULL, NULL),
(1, 831059, 'A; East Baulk Trim', NULL, NULL),
(1, 841059, 'A; East Baulk Trim', NULL, NULL),
(1, 851059, NULL, NULL, NULL),
(1, 861059, NULL, NULL, NULL),
(1, 871059, NULL, NULL, NULL),
(1, 881059, NULL, NULL, NULL),
(1, 891059, NULL, NULL, NULL),
(1, 911059, NULL, NULL, NULL),
(1, 921059, 'for piece in PB012, D; North Baulk Trim', NULL, NULL),
(1, 931059, NULL, NULL, NULL),
(1, 941059, NULL, NULL, NULL),
(1, 951059, NULL, NULL, NULL),
(1, 961059, NULL, NULL, NULL),
(1, 971059, NULL, NULL, NULL),
(1, 981059, NULL, NULL, NULL),
(1, 991059, NULL, NULL, NULL),
(1, 1001059, NULL, NULL, NULL),
(1, 1011059, NULL, NULL, NULL),
(1, 1021059, NULL, NULL, NULL),
(1, 1031059, NULL, NULL, NULL),
(1, 1041059, NULL, NULL, NULL),
(1, 1051059, NULL, NULL, NULL),
(1, 1061059, NULL, NULL, NULL),
(1, 1071059, NULL, NULL, NULL),
(1, 1081059, NULL, NULL, NULL),
(1, 1091059, NULL, NULL, NULL),
(1, 1101059, NULL, NULL, NULL),
(1, 1111059, NULL, NULL, NULL),
(1, 1121059, NULL, NULL, NULL),
(1, 1131059, NULL, NULL, NULL),
(1, 1141059, NULL, NULL, NULL),
(1, 1151059, NULL, NULL, NULL),
(1, 1161059, NULL, NULL, NULL),
(1, 1171059, NULL, NULL, NULL),
(1, 1181059, NULL, NULL, NULL),
(1, 1191059, NULL, NULL, NULL),
(1, 1201059, NULL, NULL, NULL),
(1, 1211059, NULL, NULL, NULL),
(1, 1221059, NULL, NULL, NULL),
(1, 1231059, NULL, NULL, NULL),
(1, 1241059, NULL, NULL, NULL),
(1, 1251059, NULL, NULL, NULL),
(1, 1261059, NULL, NULL, NULL),
(1, 1271059, 'no addtion for first piece; second, B; South Baulk Trim ', NULL, NULL),
(1, 1281059, NULL, NULL, NULL),
(1, 1291059, NULL, NULL, NULL),
(1, 1301059, NULL, NULL, NULL),
(1, 1311059, NULL, NULL, NULL),
(1, 1321059, NULL, NULL, NULL),
(1, 1331059, NULL, NULL, NULL),
(1, 1341059, NULL, NULL, NULL),
(1, 1351059, NULL, NULL, NULL),
(1, 1361059, NULL, NULL, NULL),
(1, 1371059, NULL, NULL, NULL),
(1, 1381059, NULL, NULL, NULL),
(1, 1391059, NULL, NULL, NULL),
(1, 1401059, NULL, NULL, NULL),
(1, 1411059, NULL, NULL, NULL),
(1, 1421059, NULL, NULL, NULL),
(1, 1431059, NULL, NULL, NULL),
(1, 1441059, NULL, NULL, NULL),
(1, 1451059, NULL, NULL, NULL),
(1, 1461059, NULL, NULL, NULL),
(1, 1471059, NULL, NULL, NULL),
(1, 1481059, 'piece from pottery bucked 12 comes from D; North Baulk Trim', NULL, NULL),
(1, 1501059, 'C; West Baulk Trim; a second piece recovered from S baulk, 09.12.2014', NULL, NULL),
(1, 1511059, NULL, NULL, NULL),
(1, 1521059, NULL, NULL, NULL),
(1, 1531059, NULL, NULL, NULL),
(1, 1541059, NULL, NULL, NULL),
(1, 1551059, NULL, NULL, NULL),
(1, 1561059, NULL, NULL, NULL),
(1, 1571059, NULL, NULL, NULL),
(1, 1581059, NULL, NULL, NULL),
(1, 1591059, NULL, NULL, NULL),
(1, 1601059, NULL, NULL, NULL),
(1, 1611059, NULL, NULL, NULL),
(1, 1641059, NULL, NULL, NULL),
(1, 1651059, NULL, NULL, NULL),
(1, 1661059, NULL, NULL, NULL),
(1, 1671059, NULL, NULL, NULL),
(1, 1681059, NULL, NULL, NULL),
(1, 1701059, NULL, NULL, NULL),
(1, 1741059, NULL, NULL, NULL),
(1, 1751059, NULL, NULL, NULL),
(1, 1771059, NULL, NULL, NULL),
(1, 1781059, NULL, NULL, NULL),
(1, 1791059, 'C; West Baulk Trim', NULL, NULL),
(1, 1801059, NULL, NULL, NULL),
(1, 1811059, NULL, NULL, NULL),
(1, 1821059, NULL, NULL, NULL),
(1, 1831059, NULL, NULL, NULL),
(1, 1841059, NULL, NULL, NULL),
(1, 1851059, NULL, NULL, NULL),
(1, 1861059, NULL, NULL, NULL),
(1, 1871059, NULL, NULL, NULL),
(1, 1881059, NULL, NULL, NULL),
(1, 1891059, NULL, NULL, NULL),
(1, 1901059, NULL, NULL, NULL),
(1, 1911059, NULL, NULL, NULL),
(1, 1921059, NULL, NULL, NULL),
(1, 1931059, NULL, NULL, NULL),
(1, 1941059, NULL, NULL, NULL),
(1, 1951059, NULL, NULL, NULL),
(1, 1961059, NULL, NULL, NULL),
(1, 1971059, NULL, NULL, NULL),
(1, 1981059, NULL, NULL, NULL),
(1, 1991059, NULL, NULL, NULL),
(1, 2001059, NULL, NULL, NULL),
(1, 2011059, NULL, NULL, NULL),
(1, 2021059, NULL, NULL, NULL),
(1, 2031059, NULL, NULL, NULL),
(1, 2041059, NULL, NULL, NULL),
(1, 2051059, NULL, NULL, NULL),
(1, 2061059, NULL, NULL, NULL),
(1, 2071059, NULL, NULL, NULL),
(1, 2081059, NULL, NULL, NULL),
(1, 2091059, NULL, NULL, NULL),
(1, 2101059, NULL, NULL, NULL),
(1, 2111059, NULL, NULL, NULL),
(1, 2121059, NULL, NULL, NULL),
(1, 2131059, NULL, NULL, NULL),
(1, 2141059, NULL, NULL, NULL),
(1, 2151059, NULL, NULL, NULL),
(1, 2161059, NULL, NULL, NULL),
(1, 2171059, 'B; South Baulk Trim', NULL, NULL),
(1, 2181059, 'B; South Baulk Trim', NULL, NULL),
(1, 2191059, NULL, NULL, NULL),
(1, 2201059, NULL, NULL, NULL),
(1, 2211059, NULL, NULL, NULL),
(1, 2221059, NULL, NULL, NULL),
(1, 2231059, NULL, NULL, NULL),
(1, 2241059, NULL, NULL, NULL),
(1, 2251059, 'B; South Baulk Trim', NULL, NULL),
(1, 2261059, NULL, NULL, NULL),
(1, 2271059, NULL, NULL, NULL),
(1, 2281059, NULL, NULL, NULL),
(1, 2291059, NULL, NULL, NULL),
(1, 2301059, NULL, NULL, NULL),
(1, 2311059, NULL, NULL, NULL),
(1, 2321059, NULL, NULL, NULL),
(1, 2331059, NULL, NULL, NULL),
(1, 2341059, 'C; West Baulk Trim', NULL, NULL),
(1, 2351059, 'C; West Baulk Trim; also D; North Baulk Trim', NULL, NULL),
(1, 2361059, NULL, NULL, NULL),
(1, 2371059, NULL, NULL, NULL),
(1, 2381059, NULL, NULL, NULL),
(1, 2391059, NULL, NULL, NULL),
(1, 2401059, NULL, NULL, NULL),
(1, 2411059, NULL, NULL, NULL),
(1, 2421059, NULL, NULL, NULL),
(1, 2431059, NULL, NULL, NULL),
(1, 2451059, NULL, NULL, NULL),
(1, 2461059, NULL, NULL, NULL),
(1, 2471059, NULL, NULL, NULL),
(1, 2481059, NULL, NULL, NULL),
(1, 2491059, NULL, NULL, NULL),
(1, 2501059, NULL, NULL, NULL),
(1, 2511059, NULL, NULL, NULL),
(1, 2521059, NULL, NULL, NULL),
(1, 2531059, 'C; West Baulk Trim', NULL, NULL),
(1, 2541059, NULL, NULL, NULL),
(1, 2551059, NULL, NULL, NULL),
(1, 2561059, NULL, NULL, NULL),
(1, 2571059, 'C; West Baulk Trim', NULL, NULL),
(1, 2581059, NULL, NULL, NULL),
(1, 2591059, NULL, NULL, NULL),
(1, 2601059, NULL, NULL, NULL),
(1, 2611059, NULL, NULL, NULL),
(1, 2621059, NULL, NULL, NULL),
(1, 2631059, NULL, NULL, NULL),
(1, 2641059, NULL, NULL, NULL),
(1, 2651059, NULL, NULL, NULL),
(1, 2661059, NULL, NULL, NULL),
(1, 2671059, NULL, NULL, NULL),
(1, 2681059, '', NULL, NULL),
(1, 2691059, NULL, NULL, NULL),
(1, 2701059, NULL, NULL, NULL),
(1, 2711059, NULL, NULL, NULL),
(1, 2721059, 'B; South Baulk Trim', NULL, NULL),
(1, 2731059, 'B; South Baulk Trim', NULL, NULL),
(1, 2741059, 'B; South Baulk Trim', NULL, NULL),
(1, 2761059, 'B; South Baulk Trim', NULL, NULL),
(1, 2771059, 'B; South Baulk Trim', NULL, NULL),
(1, 2781059, 'B; South Baulk Trim', NULL, NULL),
(1, 2791059, 'C; West Baulk Trim', NULL, NULL),
(1, 2801059, 'C; West Baulk Trim', NULL, NULL),
(1, 2811059, 'C; West Baulk Trim; also D; North Baulk Trim', NULL, NULL),
(1, 2821059, 'C; West Baulk Trim', NULL, NULL),
(1, 2831059, 'D; North Baulk Trim', NULL, NULL),
(1, 2841059, 'D; North Baulk Trim', NULL, NULL),
(1, 2851059, 'D; North Baulk Trim', NULL, NULL),
(1, 2861059, 'D; North Baulk Trim', NULL, NULL),
(1, 2871059, 'D; North Baulk Trim', NULL, NULL),
(1, 2881059, 'D; North Baulk Trim', NULL, NULL),
(1, 2891059, 'D; North Baulk Trim', NULL, NULL),
(1, 2901059, 'D; North Baulk Trim', NULL, NULL),
(1, 2911059, 'D; North Baulk Trim', NULL, NULL),
(1, 2921059, 'D; North Baulk Trim', NULL, NULL),
(1, 2931059, 'D; North Baulk Trim', NULL, NULL),
(1, 2941059, 'D; North Baulk Trim', NULL, NULL),
(1, 2951059, 'D; North Baulk Trim', NULL, NULL),
(1, 2961059, 'D; North Baulk Trim', NULL, NULL),
(1, 2971059, 'D; North Baulk Trim', NULL, NULL),
(1, 2981059, 'D; North Baulk Trim', NULL, NULL),
(1, 2991059, 'D; North Baulk Trim', NULL, NULL),
(1, 3001059, NULL, NULL, NULL),
(1, 3011059, NULL, NULL, NULL),
(1, 3021059, NULL, NULL, NULL),
(1, 3031059, NULL, NULL, NULL),
(1, 3041059, NULL, NULL, NULL),
(1, 3051059, NULL, NULL, NULL),
(1, 3061059, NULL, NULL, NULL),
(1, 3071059, NULL, NULL, NULL),
(1, 3081059, NULL, NULL, NULL),
(1, 3091059, NULL, NULL, NULL),
(1, 3101059, NULL, NULL, NULL),
(1, 3111059, NULL, NULL, NULL),
(1, 3121059, NULL, NULL, NULL),
(1, 3131059, NULL, NULL, NULL),
(1, 3141059, NULL, NULL, NULL),
(1, 3151059, NULL, NULL, NULL),
(1, 3161059, NULL, NULL, NULL),
(1, 3171059, NULL, NULL, NULL),
(1, 3181059, NULL, NULL, NULL),
(1, 3191059, NULL, NULL, NULL),
(1, 3201059, NULL, NULL, NULL),
(1, 3211059, NULL, NULL, NULL),
(1, 3221059, NULL, NULL, NULL),
(1, 3231059, NULL, NULL, NULL),
(1, 3241059, NULL, NULL, NULL),
(1, 3261059, NULL, NULL, NULL),
(1, 3411059, 'surface find, PB001', NULL, NULL),
(1, 2700190120, NULL, NULL, NULL),
(1, 3500190120, NULL, NULL, NULL),
(1, 4900190120, NULL, NULL, NULL),
(1, 5000190120, NULL, NULL, NULL),
(1, 5100190120, NULL, NULL, NULL),
(1, 5200190120, NULL, NULL, NULL),
(1, 5300190120, NULL, NULL, NULL),
(1, 5400190120, NULL, NULL, NULL),
(1, 5500190120, NULL, NULL, NULL),
(1, 5600190120, NULL, NULL, NULL),
(1, 5700190120, NULL, NULL, NULL),
(1, 5800190120, NULL, NULL, NULL),
(1, 5900190120, NULL, NULL, NULL),
(1, 6000190120, NULL, NULL, NULL),
(1, 6100190120, NULL, NULL, NULL),
(1, 6200190120, NULL, NULL, NULL),
(1, 6300190120, NULL, NULL, NULL),
(1, 6500190120, NULL, NULL, NULL),
(1, 6600190120, NULL, NULL, NULL),
(1, 6700190120, NULL, NULL, NULL),
(1, 6900190120, NULL, NULL, NULL),
(1, 7000190120, NULL, NULL, NULL),
(1, 7100190120, NULL, NULL, NULL),
(1, 7200190120, NULL, NULL, NULL),
(1, 7300190120, NULL, NULL, NULL),
(1, 7400190120, NULL, NULL, NULL),
(1, 7800190120, NULL, NULL, NULL),
(1, 7900190120, NULL, NULL, NULL),
(1, 8000190120, NULL, NULL, NULL),
(1, 8100190120, NULL, NULL, NULL),
(2, 3251059, '2 frags; one from PB019; the other from PB 022, 2B, South Baulk Trim', NULL, NULL),
(2, 3271059, NULL, NULL, NULL),
(2, 3281059, NULL, NULL, NULL),
(2, 3291059, 'multiple frags, PB020 and PB025; locus 2A, East Baulk Trim, PB021', NULL, NULL),
(2, 3301059, 'B; South Baulk Trim', NULL, NULL),
(2, 3311059, 'B; South Baulk Trim', NULL, NULL),
(2, 3321059, 'B; South Baulk Trim', NULL, NULL),
(2, 3331059, 'B; South Baulk Trim', NULL, NULL),
(2, 3341059, 'B; South Baulk Trim', NULL, NULL),
(2, 3351059, 'B; South Baulk Trim', NULL, NULL),
(2, 3361059, 'B; South Baulk Trim', NULL, NULL),
(2, 3371059, 'B; South Baulk Trim', NULL, NULL),
(2, 3381059, 'D; North Baulk Trim', NULL, NULL),
(2, 3391059, NULL, NULL, NULL),
(2, 3401059, NULL, NULL, NULL),
(2, 100180114, 'SGR (Sidney, a canadian guy that dug the trench), lives in AZ', NULL, NULL),
(2, 100190120, NULL, NULL, NULL),
(2, 100190122, NULL, NULL, NULL),
(2, 200190120, NULL, NULL, NULL),
(2, 200190122, NULL, NULL, NULL),
(2, 300190120, NULL, NULL, NULL),
(2, 300190122, NULL, NULL, NULL),
(2, 400190120, NULL, NULL, NULL),
(2, 500190120, NULL, NULL, NULL),
(2, 500190122, NULL, NULL, NULL),
(2, 600190120, NULL, NULL, NULL),
(2, 600190122, NULL, NULL, NULL),
(2, 700180114, NULL, NULL, NULL),
(2, 700190120, NULL, NULL, NULL),
(2, 700190122, NULL, NULL, NULL),
(2, 800180114, NULL, NULL, NULL),
(2, 800190120, NULL, NULL, NULL),
(2, 900180114, NULL, NULL, NULL),
(2, 1000180114, NULL, NULL, NULL),
(2, 1000190120, NULL, NULL, NULL),
(2, 1000190122, NULL, NULL, NULL),
(2, 1100190120, NULL, NULL, NULL),
(2, 1200190120, NULL, NULL, NULL),
(2, 1200190122, NULL, NULL, NULL),
(2, 1300190120, NULL, NULL, NULL),
(2, 1300190122, NULL, NULL, NULL),
(2, 1400190120, NULL, NULL, NULL),
(2, 1400190122, NULL, NULL, NULL),
(2, 1500190120, NULL, NULL, NULL),
(2, 1500190122, NULL, NULL, NULL),
(2, 1600180114, 'SGR Sidney', NULL, NULL),
(2, 1600190120, NULL, NULL, NULL),
(2, 1700180114, 'SGR Sidney', NULL, NULL),
(2, 1800180114, 'SGR Sidney', NULL, NULL),
(2, 1800190120, NULL, NULL, NULL),
(2, 1900180114, 'SGR Sidney', NULL, NULL),
(2, 1900190120, NULL, NULL, NULL),
(2, 2000180114, 'Sidney SGR', NULL, NULL),
(2, 2000190120, NULL, NULL, NULL),
(2, 2100190120, NULL, NULL, NULL),
(2, 2200190120, NULL, NULL, NULL),
(2, 2300190120, NULL, NULL, NULL),
(2, 2400190120, NULL, NULL, NULL),
(2, 2500190120, NULL, NULL, NULL),
(2, 2600190120, NULL, NULL, NULL),
(2, 2800190120, NULL, NULL, NULL),
(2, 2900190120, NULL, NULL, NULL),
(2, 3000190120, NULL, NULL, NULL),
(2, 3100190120, NULL, NULL, NULL),
(2, 3200190120, NULL, NULL, NULL),
(2, 3300190120, NULL, NULL, NULL),
(2, 3400190120, NULL, NULL, NULL),
(2, 3600190120, NULL, NULL, NULL),
(2, 3700190120, NULL, NULL, NULL),
(2, 3800190120, NULL, NULL, NULL),
(2, 3900190120, NULL, NULL, NULL),
(3, 100180118, NULL, NULL, NULL),
(3, 300180114, 'SGR Sidney', NULL, NULL),
(3, 400180114, 'SGR Sidney', NULL, NULL),
(3, 500180114, NULL, NULL, NULL),
(3, 1100180114, 'SGR Sidney', NULL, NULL),
(3, 1200180114, 'SGR Sidney', NULL, NULL),
(3, 1300180114, 'SGR Sidney', NULL, NULL),
(3, 1400180114, 'SGR Sidney', NULL, NULL),
(3, 1500180114, 'SGR Sidney', NULL, NULL),
(3, 4000190120, NULL, NULL, NULL),
(3, 4100190120, NULL, NULL, NULL),
(3, 4200190120, NULL, NULL, NULL),
(3, 4300190120, NULL, NULL, NULL),
(3, 4400190120, NULL, NULL, NULL),
(3, 4500190120, NULL, NULL, NULL),
(3, 4600190120, NULL, NULL, NULL),
(3, 4700190120, NULL, NULL, NULL),
(3, 4800190120, NULL, NULL, NULL),
(4, 601059, 'B; South Baulk Trim', NULL, NULL),
(4, 611059, 'B; South Baulk Trim', NULL, NULL),
(4, 621059, 'B; South Baulk Trim', NULL, NULL),
(4, 631059, 'C; West Baulk Trim', NULL, NULL),
(4, 641059, 'C; West Baulk Trim', NULL, NULL),
(4, 651059, 'C; West Baulk Trim', NULL, NULL),
(4, 661059, 'C; West Baulk Trim', NULL, NULL),
(4, 671059, 'C; West Baulk Trim', NULL, NULL),
(4, 681059, 'C; West Baulk Trim', NULL, NULL),
(4, 691059, 'C; West Baulk Trim', NULL, NULL),
(4, 701059, 'C; West Baulk Trim', NULL, NULL),
(4, 901059, 'C; West Baulk Trim', NULL, NULL),
(4, 3421059, 'A; East Baulk Trim', NULL, NULL),
(4, 3431059, 'A; East Baulk Trim', NULL, NULL),
(4, 3441059, 'A; East Baulk Trim', NULL, NULL),
(4, 3451059, '?', NULL, NULL),
(4, 3461059, '?', NULL, NULL),
(4, 3471059, 'C; West Baulk Trim', NULL, NULL),
(5, 200180114, 'SGR (Sidney)', NULL, NULL),
(5, 600180114, 'SGR Sidney', NULL, NULL),
(5, 1100190122, NULL, NULL, NULL),
(17, 300180111, '111A, more precisely', NULL, NULL),
(35, 100180111, NULL, NULL, NULL),
(35, 200180111, NULL, NULL, NULL);

-- --------------------------------------------------------

--
-- Tabellenstruktur für Tabelle `textile_pottery_bucket`
--

CREATE TABLE `textile_pottery_bucket` (
  `Textile_ID13` bigint(20) NOT NULL,
  `Pottery_bucket_number1` int(11) NOT NULL,
  `Date_excavation` date DEFAULT NULL,
  `bucket_id` int(11) DEFAULT NULL,
  `bucket_locus_trench` varchar(512) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;

--
-- Daten für Tabelle `textile_pottery_bucket`
--

INSERT INTO `textile_pottery_bucket` (`Textile_ID13`, `Pottery_bucket_number1`, `Date_excavation`, `bucket_id`, `bucket_locus_trench`) VALUES
(371059, 7, '2010-01-13', 156, '7_1_59'),
(381059, 7, '2010-01-13', 156, '7_1_59'),
(391059, 7, '2010-01-13', 156, '7_1_59'),
(401059, 7, '2010-01-13', 156, '7_1_59'),
(411059, 7, '2010-01-13', 156, '7_1_59'),
(421059, 7, '2010-01-13', 156, '7_1_59'),
(431059, 7, '2010-01-13', 156, '7_1_59'),
(441059, 7, '2010-01-13', 156, '7_1_59'),
(451059, 7, '2010-01-13', 156, '7_1_59'),
(461059, 7, '2010-01-13', 156, '7_1_59'),
(471059, 7, '2010-01-13', 156, '7_1_59'),
(481059, 7, '2010-01-13', 156, '7_1_59'),
(551059, 15, '2010-01-17', 164, '15_1_59'),
(561059, 15, '2010-01-17', 164, '15_1_59'),
(571059, 15, '2010-01-17', 164, '15_1_59'),
(581059, 15, '2010-01-17', 164, '15_1_59'),
(591059, 1, '2010-01-04', 150, '1_1_59'),
(1841059, 4, '2010-01-10', 153, '4_1_59'),
(1851059, 4, '2010-01-10', 153, '4_1_59'),
(1861059, 4, '2010-01-10', 153, '4_1_59'),
(1871059, 4, '2010-01-10', 153, '4_1_59'),
(1881059, 4, '2010-01-10', 153, '4_1_59'),
(1891059, 4, '2010-01-10', 153, '4_1_59'),
(1901059, 4, '2010-01-10', 153, '4_1_59'),
(1911059, 1, '2010-01-04', 150, '1_1_59'),
(1921059, 4, '2010-01-10', 153, '4_1_59'),
(1931059, 2, '2010-01-07', 151, '2_1_59'),
(1941059, 1, '2010-01-04', 150, '1_1_59'),
(1951059, 1, '2010-01-04', 150, '1_1_59'),
(1961059, 1, '2010-01-04', 150, '1_1_59'),
(1971059, 1, '2010-01-04', 150, '1_1_59'),
(1981059, 1, '2010-01-04', 150, '1_1_59'),
(1991059, 1, '2010-01-04', 150, '1_1_59'),
(2001059, 1, '2010-01-04', 150, '1_1_59'),
(2011059, 1, '2010-01-04', 150, '1_1_59'),
(2021059, 1, '2010-01-04', 150, '1_1_59'),
(2031059, 1, '2010-01-04', 150, '1_1_59'),
(2041059, 1, '2010-01-04', 150, '1_1_59'),
(2051059, 1, '2010-01-04', 150, '1_1_59'),
(2061059, 1, '2010-01-04', 150, '1_1_59'),
(2071059, 1, '2010-01-04', 150, '1_1_59'),
(2081059, 1, '2010-01-04', 150, '1_1_59'),
(2091059, 1, '2010-01-04', 150, '1_1_59'),
(2101059, 1, '2010-01-04', 150, '1_1_59'),
(2111059, 1, '2010-01-04', 150, '1_1_59'),
(2121059, 1, '2010-01-04', 150, '1_1_59'),
(2131059, 1, '2010-01-04', 150, '1_1_59'),
(2141059, 1, '2010-01-04', 150, '1_1_59'),
(2151059, 1, '2010-01-04', 150, '1_1_59'),
(2161059, 1, '2010-01-04', 150, '1_1_59'),
(2171059, 10, '2010-01-14', 159, '10_1_59'),
(2181059, 10, '2010-01-14', 159, '10_1_59'),
(2191059, 2, '2010-01-07', 151, '2_1_59'),
(2201059, 2, '2010-01-07', 151, '2_1_59'),
(2211059, 2, '2010-01-07', 151, '2_1_59'),
(2221059, 2, '2010-01-07', 151, '2_1_59'),
(2231059, 2, '2010-01-07', 151, '2_1_59'),
(2241059, 2, '2010-01-07', 151, '2_1_59'),
(2251059, 10, '2010-01-14', 159, '10_1_59'),
(2261059, 2, '2010-01-07', 151, '2_1_59'),
(2271059, 2, '2010-01-07', 151, '2_1_59'),
(2281059, 2, '2010-01-07', 151, '2_1_59'),
(2291059, 2, '2010-01-07', 151, '2_1_59'),
(2301059, 2, '2010-01-07', 151, '2_1_59'),
(2311059, 2, '2010-01-07', 151, '2_1_59'),
(2321059, 2, '2010-01-07', 151, '2_1_59'),
(2331059, 2, '2010-01-07', 151, '2_1_59'),
(2341059, 11, '2010-01-16', 160, '11_1_59'),
(2351059, 11, '2010-01-16', 160, '11_1_59'),
(2361059, 2, '2010-01-07', 151, '2_1_59'),
(2371059, 2, '2010-01-07', 151, '2_1_59'),
(2381059, 2, '2010-01-07', 151, '2_1_59'),
(2391059, 2, '2010-01-07', 151, '2_1_59'),
(2401059, 2, '2010-01-07', 151, '2_1_59'),
(2411059, 2, '2010-01-07', 151, '2_1_59'),
(2421059, 2, '2010-01-07', 151, '2_1_59'),
(2431059, 2, '2010-01-07', 151, '2_1_59'),
(2451059, 2, '2010-01-07', 151, '2_1_59'),
(2461059, 1, '2010-01-04', 150, '1_1_59'),
(2471059, 2, '2010-01-07', 151, '2_1_59'),
(2481059, 2, '2010-01-07', 151, '2_1_59'),
(2491059, 2, '2010-01-07', 151, '2_1_59'),
(2501059, 2, '2010-01-07', 151, '2_1_59'),
(2511059, 2, '2010-01-07', 151, '2_1_59'),
(2521059, 2, '2010-01-07', 151, '2_1_59'),
(2531059, 11, '2010-01-16', 160, '11_1_59'),
(2541059, 2, '2010-01-07', 151, '2_1_59'),
(2551059, 2, '2010-01-07', 151, '2_1_59'),
(2561059, 2, '2010-01-07', 151, '2_1_59'),
(2571059, 11, '2010-01-16', 160, '11_1_59'),
(2581059, 2, '2010-01-07', 151, '2_1_59'),
(2591059, 2, '2010-01-07', 151, '2_1_59'),
(2601059, 2, '2010-01-07', 151, '2_1_59'),
(2611059, 2, '2010-01-07', 151, '2_1_59'),
(2621059, 3, '2010-01-09', 152, '3_1_59'),
(2631059, 3, '2010-01-09', 152, '3_1_59'),
(2641059, 3, '2010-01-09', 152, '3_1_59'),
(2651059, 3, '2010-01-09', 152, '3_1_59'),
(2661059, 3, '2010-01-09', 152, '3_1_59'),
(2671059, 3, '2010-01-09', 152, '3_1_59'),
(2681059, 3, '2010-01-09', 152, '3_1_59'),
(2691059, 3, '2010-01-09', 152, '3_1_59'),
(2701059, 3, '2010-01-09', 152, '3_1_59'),
(2711059, 3, '2010-01-09', 152, '3_1_59'),
(2721059, 10, '2010-01-14', 159, '10_1_59'),
(2731059, 10, '2010-01-14', 159, '10_1_59'),
(2741059, 10, '2010-01-14', 159, '10_1_59'),
(2761059, 10, '2010-01-14', 159, '10_1_59'),
(2771059, 10, '2010-01-14', 159, '10_1_59'),
(2781059, 10, '2010-01-14', 159, '10_1_59'),
(2791059, 11, '2010-01-16', 160, '11_1_59'),
(2801059, 11, '2010-01-16', 160, '11_1_59'),
(2811059, 11, '2010-01-16', 160, '11_1_59'),
(2821059, 11, '2010-01-16', 160, '11_1_59'),
(2831059, 12, '2010-01-16', 161, '12_1_59'),
(2841059, 12, '2010-01-16', 161, '12_1_59'),
(2851059, 12, '2010-01-16', 161, '12_1_59'),
(2861059, 12, '2010-01-16', 161, '12_1_59'),
(2871059, 12, '2010-01-16', 161, '12_1_59'),
(2881059, 12, '2010-01-16', 161, '12_1_59'),
(2891059, 12, '2010-01-16', 161, '12_1_59'),
(2901059, 12, '2010-01-16', 161, '12_1_59'),
(2911059, 12, '2010-01-16', 161, '12_1_59'),
(2921059, 12, '2010-01-16', 161, '12_1_59'),
(2931059, 12, '2010-01-16', 161, '12_1_59'),
(2941059, 12, '2010-01-16', 161, '12_1_59'),
(2951059, 12, '2010-01-16', 161, '12_1_59'),
(2400190120, 3, '2019-01-19', 4913, '3_2_120'),
(2500190120, 3, '2019-01-19', 4913, '3_2_120'),
(2600190120, 3, '2019-01-19', 4913, '3_2_120'),
(2700190120, 1, '2020-01-18', 4911, '1_1_120'),
(2800190120, 3, '2019-01-19', 4913, '3_2_120'),
(2900190120, 3, '2019-01-19', 4913, '3_2_120'),
(3000190120, 3, '2019-01-19', 4913, '3_2_120'),
(3100190120, 5, '2019-01-12', 4915, '5_2_120'),
(3200190120, 5, '2019-01-12', 4915, '5_2_120'),
(3300190120, 5, '2019-01-12', 4915, '5_2_120'),
(3400190120, 4, '2019-01-10', 4914, '4_2_120'),
(3500190120, 2, '2019-01-08', 4912, '2_1_120'),
(3600190120, 4, '2019-01-10', 4914, '4_2_120'),
(3700190120, 4, '2019-01-10', 4914, '4_2_120'),
(3800190120, 4, '2019-01-10', 4914, '4_2_120'),
(3900190120, 4, '2019-01-10', 4914, '4_2_120'),
(4000190120, 6, '2019-01-13', 4916, '6_3_120'),
(4100190120, 6, '2019-01-13', 4916, '6_3_120'),
(4200190120, 6, '2019-01-13', 4916, '6_3_120'),
(4300190120, 6, '2019-01-13', 4916, '6_3_120'),
(4400190120, 6, '2019-01-13', 4916, '6_3_120'),
(4500190120, 6, '2019-01-13', 4916, '6_3_120'),
(4600190120, 6, '2019-01-13', 4916, '6_3_120'),
(4700190120, 6, '2019-01-13', 4916, '6_3_120'),
(4800190120, 6, '2019-01-13', 4916, '6_3_120'),
(4900190120, 1, '2019-01-07', 4911, '1_1_120'),
(5000190120, 1, '2019-01-07', 4911, '1_1_120'),
(5100190120, 1, '2019-01-07', 4911, '1_1_120'),
(5200190120, 1, '2019-01-07', 4911, '1_1_120'),
(5300190120, 1, '2019-01-07', 4911, '1_1_120'),
(5400190120, 1, '2019-01-07', 4911, '1_1_120'),
(5500190120, 1, '2019-01-07', 4911, '1_1_120'),
(5600190120, 1, '2019-01-07', 4911, '1_1_120'),
(5700190120, 1, '2019-01-07', 4911, '1_1_120'),
(5800190120, 1, '2019-01-07', 4911, '1_1_120'),
(5900190120, 1, '2019-01-07', 4911, '1_1_120'),
(6000190120, 1, '2019-01-07', 4911, '1_1_120'),
(6100190120, 1, '2019-01-07', 4911, '1_1_120'),
(6200190120, 1, '2019-01-07', 4911, '1_1_120'),
(6300190120, 1, '2019-01-07', 4911, '1_1_120'),
(6400190120, 1, '2019-01-07', 4911, NULL),
(6500190120, 1, '2019-01-07', 4911, '1_1_120'),
(6600190120, 1, '2019-01-07', 4911, '1_1_120'),
(6700190120, 2, '2019-01-08', 4912, '2_1_120'),
(6900190120, 1, '2019-01-08', 4911, '1_1_120'),
(7000190120, 2, '2019-01-08', 4912, '2_1_120'),
(7100190120, 2, '2019-01-08', 4912, '2_1_120'),
(7200190120, 2, '2019-01-08', 4912, '2_1_120'),
(7300190120, 2, '2019-01-08', 4912, '2_1_120'),
(7400190120, 2, '2018-01-08', 4912, '2_1_120'),
(7800190120, 2, '2018-01-08', 4912, '2_1_120'),
(7900190120, 2, '2018-01-08', 4912, '2_1_120'),
(8000190120, 2, '2018-01-08', 4912, '2_1_120'),
(8100190120, 2, '2018-01-08', 4912, '2_1_120');
...
--
-- Tabellenstruktur für Tabelle `textile_trench`
--

CREATE TABLE `textile_trench` (
  `Textile_ID11` bigint(20) NOT NULL,
  `Trench_number1` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;

--
-- Daten für Tabelle `textile_trench`
--

INSERT INTO `textile_trench` (`Textile_ID11`, `Trench_number1`) VALUES
(371059, 59),
(381059, 59),
(391059, 59),
(401059, 59),
...
--
-- Tabellenstruktur für Tabelle `trench_t`
--

CREATE TABLE `trench_t` (
  `Trench_number` int(11) NOT NULL,
  `Year` int(11) DEFAULT NULL,
  `Context` varchar(100) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;

--
-- Daten für Tabelle `trench_t`
--

INSERT INTO `trench_t` (`Trench_number`, `Year`, `Context`) VALUES
(59, 2010, 'late roman trash btw houses'),
(60, 2010, 'early roman trash'),
(111, 2018, 'isis temple'),
(112, 2015, 'isis temple, also re-opened in 2019'),
(114, 2018, 'isis temple'),
(118, 2018, 'isis temple'),
(120, 2019, 'isis temple'),
(122, 2019, 'isis temple'),
(137, 2020, 'isis temple');
...
--
-- Indizes für die Tabelle `locus_t`
--
ALTER TABLE `locus_t`
  ADD PRIMARY KEY (`Locus_number`);

--
-- Indizes für die Tabelle `pottery_bucket`
--
ALTER TABLE `pottery_bucket`
  ADD PRIMARY KEY (`Pottery_bucket_number`);
...
--
-- Indizes für die Tabelle `textile_locus`
--
ALTER TABLE `textile_locus`
  ADD PRIMARY KEY (`Locus_number1`,`Textile_ID12`),
  ADD KEY `Textile_ID12_idx` (`Textile_ID12`);

--
-- Indizes für die Tabelle `textile_pottery_bucket`
--
ALTER TABLE `textile_pottery_bucket`
  ADD PRIMARY KEY (`Textile_ID13`,`Pottery_bucket_number1`),
  ADD KEY `Pottery_bucket_number1_idx` (`Pottery_bucket_number1`);
...
--
-- Indizes für die Tabelle `textile_trench`
--
ALTER TABLE `textile_trench`
  ADD PRIMARY KEY (`Textile_ID11`,`Trench_number1`),
  ADD KEY `Trench_number1_idx` (`Trench_number1`);

--
-- Indizes für die Tabelle `trench_t`
--
ALTER TABLE `trench_t`
  ADD PRIMARY KEY (`Trench_number`);
...
--
-- Constraints der Tabelle `textile_locus`
--
ALTER TABLE `textile_locus`
  ADD CONSTRAINT `Locus_number1` FOREIGN KEY (`Locus_number1`) REFERENCES `locus_t` (`Locus_number`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `Textile_ID12` FOREIGN KEY (`Textile_ID12`) REFERENCES `textile` (`Textile_ID`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints der Tabelle `textile_pottery_bucket`
--
ALTER TABLE `textile_pottery_bucket`
  ADD CONSTRAINT `Pottery_bucket_number1` FOREIGN KEY (`Pottery_bucket_number1`) REFERENCES `pottery_bucket` (`Pottery_bucket_number`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `Textile_ID13` FOREIGN KEY (`Textile_ID13`) REFERENCES `textile` (`Textile_ID`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
-- Constraints der Tabelle `textile_trench`
--
ALTER TABLE `textile_trench`
  ADD CONSTRAINT `Textile_ID11` FOREIGN KEY (`Textile_ID11`) REFERENCES `textile` (`Textile_ID`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `Trench_number1` FOREIGN KEY (`Trench_number1`) REFERENCES `trench_t` (`Trench_number`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
